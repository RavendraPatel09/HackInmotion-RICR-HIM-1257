...
export const AdminAnalytics: React.FC = () => {
 ...
 <BarChart3 className="w-8 h-8 text-[#053229] " /> Municipal Analytics &amp; Hotspots
 </h1>
 ...
 <div className="p-6 rounded-3xl bg-gradient-to-r from-amber-500/10 via-slate-100 to-slate-200 border border-amber-500/30 space-y-6 shadow-xl">
 <div className="flex items-center justify-between">
 <div className="space-y-1">
 <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 text-amber-700 border border-amber-500/20 text-xs font-bold">
 <Zap className="w-3.5 h-3.5" /> Spatial Clustering Engine
 </span>
 <h2 className="text-2xl font-black text-[#10201C] ">Predictive Hotspot Zones</h2>
 ...
 return (
 <div key={hs.id} className="p-5 rounded-2xl bg-white border border-amber-500/30 space-y-4 shadow-lg">
 <div className="flex items-center justify-between">
 ...
 <span className="px-2 py-0.5 rounded text-[10px] font-extrabold uppercase bg-rose-500/10 text-rose-600 border border-rose-500/20">
 {hs.severity} Priority
 </span>
 </div>

 <div className="space-y-1 text-xs text-[#536761] ">
 <p>
 <strong className="text-[#10201C] ">{hs.reportCount} reports</strong> within 300m radius
 </p>
 <p className="text-[11px] text-[#536761] ">
 Category: <span className="text-amber-600 font-semibold uppercase">{hs.category}</span>
 </p>
 <p className="text-[11px] text-[#536761] ">
 Trend: <span className="text-emerald-600 font-semibold uppercase">{hs.trend}</span>
 </p>
 </div>
 ...
 isNotified
 ? 'bg-slate-200 text-[#536761] border border-slate-300 cursor-not-allowed'
 ...
 <h3 className="font-bold text-lg text-[#10201C] ">Issues by Category</h3>
 <CategoryBarChart issues={issues} />
 </div>

 <div className="p-6 rounded-3xl bg-white border border-slate-200 space-y-4 shadow-lg">
 <h3 className="font-bold text-lg text-[#10201C] ">Issue Status Distribution</h3>
 <StatusPieChart issues={issues} />
 </div>

 <div className="p-6 rounded-3xl bg-white border border-slate-200 space-y-4 shadow-lg">
 <h3 className="font-bold text-lg text-[#10201C] ">Average Resolution Time (Hours)</h3>
 <ResolutionTimeChart issues={issues} />
 </div>

 <div className="p-6 rounded-3xl bg-white border border-slate-200 space-y-4 shadow-lg">
 <h3 className="font-bold text-lg text-[#10201C] ">Reporting Volume Trends</h3>
