        ...
        >
          ...
          <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-slate-400">{matchingIssue.trackingId}</span>
              <StatusBadge status={matchingIssue.status} />
            </div>
            <h4 className="font-bold text-sm text-white">{matchingIssue.title}</h4>
            <p className="text-xs text-slate-400 line-clamp-2">{matchingIssue.description}</p>
            
            <div className="flex items-center justify-between text-xs text-slate-400 pt-2 border-t border-slate-900">
              <span className="flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-indigo-400" /> {matchingIssue.address}
              </span>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
            <button
              ...
              className="w-full sm:w-auto flex-1 py-2.5 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold transition-all shadow-lg shadow-indigo-600/30 flex items-center justify-center gap-2"
            >
