  ...
  const getVariantStyles = (v: CardVariant) => {
    switch (v) {
      ...
      case 'indigo': // Community
        return 'bg-[#F7F8FF] border-indigo-150 hover:border-indigo-400/80 hover:shadow-[0_8px_30px_rgba(99,102,241,0.08)] hover:ring-1 hover:ring-indigo-500/10';
      case 'default':
      default:
        return 'bg-white border-slate-200/80 hover:border-indigo-300 hover:shadow-[0_8px_30px_rgba(99,102,241,0.06)] hover:ring-1 hover:ring-indigo-500/5';
    }
  };
