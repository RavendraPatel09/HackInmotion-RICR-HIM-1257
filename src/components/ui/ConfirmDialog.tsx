...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-indigo-600 hover:bg-indigo-500 text-white shadow-indigo-900/40',
      ...
      <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
        ...
        >
          ...
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-xl bg-slate-800 border border-slate-700 text-indigo-400 shrink-0">
